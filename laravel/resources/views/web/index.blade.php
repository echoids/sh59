...
<head>
    ...
    <title>首页</title>
    <link rel="stylesheet" href="{{asset('web/Theme/default/Css/nav.css')}}" />
    <link rel="stylesheet" href="{{asset('web/Theme/default/Css/index.css')}}" />
    <link rel="stylesheet" href="{{asset('web/Theme/default/Css/bottom.css')}}" />
    <link rel="stylesheet" href="{{asset('web/Uploadify/uploadify.css"/>
    ...
    <div id="left" class='fleft'>
        ...
        <div class="group">
            ...
            <ul>
                ...
                <foreach name='group' item='v'>
                    <li>
                        <a href=""><i class='icon icon-group'></i>&nbsp;&nbsp;{$v.name}</a>
                    </li>
                </foreach>
            </ul>
                ...
                <div class="wb_cons">
                    ...
                    <if condition="$v['max']">
                        <dd>
                            <div class='wb_img'>
                            <!--小图-->
                                <img src="./Uploads/Pic/{$v.mini}" class='mini_img'/>
                                ...
                                <!--中图-->
                                    <div class="img_info"><img src="./Uploads/Pic/{$v.medium}"/></div>
                                </div>
                            </div>
                        </dd>
                    </if>
                            ...
                            <div class="wb_turn">
                                ...
                                <if condition='$v["isturn"]["max"]'>
                                    <dd>
                                        <div class="turn_img">
                                        <!--小图-->
                                            <img src="./Uploads/Pic/" class='turn_mini_img'/>
                                            <div class="turn_img_tool hidden">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <i class='icon icon-bigpic'></i>
                                                        <a href="./Uploads/Pic/{$v.isturn.max}" target='_blank'>&nbsp;查看大图</a>
                                                    </li>
                                                </ul>
                                            <!--中图-->
...
<userinfo id='$_SESSION["uid"]'>
    <dl class="user_face">
        <dt>
            <a href="">
                <img src="<if condition='$face'>__ROOT__/Uploads/Face/{$face}<else/>__PUBLIC__/Images/noface.gif</if>" width='80' height='80' alt="" />
            </a>
        </dt>
        <dd>
            <a href="">{$username}</a>
    ...
    <ul class='num_list'>
        <li><a href=""><strong>{$follow}</strong><span>关注</span></a></li>
        <li><a href=""><strong>{$fans}</strong><span>粉丝</span></a></li>
        <li class='noborder'>
            <a href=""><strong>{$weibo}</strong><span>微博</span></a>
        </li>
    </ul>
</userinfo>
    <div class="maybe">
