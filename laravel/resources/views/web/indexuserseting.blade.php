...
<head>
	...
	<link rel="stylesheet" href="{{asset('web/Theme/default/Css/edit.css')}}" />
    <link rel="stylesheet" href="./Uploadify/uploadify.css"/>
	<script type="text/javascript" src="{{asset('web/Js/jquery-1.7.2.min.js')}}"></script>
	<script type="text/javascript" src="{{asset('web/Js/nav.js')}}"></script>
    <script type='text/javascript' src="{{asset('web/Js/city.js')}}"></script>
	<script type='text/javascript' src="{{asset('web/Js/edit.js')}}"></script>
    <script type="text/javascript" src="{{asset('web/Uploadify/jquery.uploadify.min.js')}}"></script>
...
<!--==========内容主体==========-->
    ...
    <!--=====右侧=====-->
    	<div id='right'>
    		...
    		<div class='form'>
    			<form action="{:U('editBasic')}" method='post'>
    				<p>
    					...
    					<input type="text" name='nickname' value='{$user.username}' class='input'/>
    				</p>
    				<p>
    			...
    			<form action="{:U('editFace')}" method='post'>
	    			<div class='edit-face'>
                        ...
                        <if condition='$user["face180"]'>
                            __ROOT__/Uploads/Face/{$user.face180}
                        <else/>
    		...
    		<div class='form hidden'>
    			<form action="{:U('editPwd')}" method='post' name='editPwd'>
